...
import org.kurator.akka.messages.DeregisterListener;
...
public class PythonActor extends UntypedActor {
    ...
    public PythonActor(Map<String,Object> configuration, Map<String, Object> settings) throws Exception {
    ...
    private void broadcastOutputs() {
        System.out.println("Broadcasting outputs");
    ...
    private void broadcastOutput(Object output) {
        ...
        if (output != null || broadcastNulls) {
            if (listener != null) listener.tell(output, self());
        }
    }
